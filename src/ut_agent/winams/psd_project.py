"""CSV-driven PSD generation using one C++ Clang extraction pass.
...
def load_psd_index(index_csv: Path, product_root: Path) -> tuple[PsdIndexRow, ...]:
...
def generate_psd_project(
    ...
    *,
    ...
    (output_root / "psd-generation-report.json").write_text(
