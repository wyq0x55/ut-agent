...
C 源码 + 配置头
  ...
  ▼
┌────────────────────────────────────────────────────────┐
│  tooling/ut-clang-extract  C++ LibTooling 语义提取      │
├────────────────────────────────────────────────────────┤
│  ut_agent.ir               FunctionIR v3 Schema / 进程边界│
├────────────────────────────────────────────────────────┤
│  ut_agent.baseline         TestBaseline & ProjectRulePack  │
├────────────────────────────────────────────────────────┤
│  ut_agent.generation       TestObligation/Constraint/Solve │
├────────────────────────────────────────────────────────┤
│  ut_agent.targets.winams   WinAMS CSV, Stub & DefineVar    │
├────────────────────────────────────────────────────────┤
│  ut_agent.toolchain        Harness & ARM GCC / Host 执行器 │
├────────────────────────────────────────────────────────┤
│  ut_agent.llm              LLM 兜底（来源判定/stub/闭环）  │
└────────────────────────────────────────────────────────┘
```
